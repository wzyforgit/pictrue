...
/*通用打开函数*/
extern void* getDataMap(char* fileName, picHead *h);

/*通用关闭函数*/
extern void savePicture(char* fileName, picHead *h, void *dataMap);
...
/*傅立叶变换*/
extern dm8* DFT(picHead *h, dm8 *dataMap);

/*伪FFT*/
/*extern dm8* FFT(picHead *h, dm8 *dataMap);*/
extern dm8* FFT(picHead *h, dm8 *dataMap);
